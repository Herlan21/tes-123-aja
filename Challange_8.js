const dataPenjualanNovel = [
    ...
    {
  //     Penulis Terlaris dan Produk Buku Terlaris
  ...
  //	Mencari total terjual paling banyak 
  ...
  // Keuntungan
  keuntungan+= (dataPenjualanNovel[i].hargaJual - dataPenjualanNovel[i].hargaBeli) * 		dataPenjualanNovel[i].totalTerjual;
    
  // modal
  modal+= dataPenjualanNovel[i].hargaBeli * (dataPenjualanNovel[i].sisaStok + dataPenjualanNovel[i].totalTerjual)     
...
// Menampilkan output ke dalam object
  dataNovel = {
